...
class ScanQRCodeController: LBXScanViewController {
    /**
     @brief  扫码区域上方提示文字
     */
    ...
    func drawBottomItems()
    {
        ...
        btnMyQR.setImage(UIImage(named: "qrcode_scan_btn_myqrcode_nor"), for: UIControlState.normal)
        btnMyQR.setImage(UIImage(named: "qrcode_scan_btn_myqrcode_down"), for: UIControlState.highlighted)
