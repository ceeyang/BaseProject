...
SWIFT_MODULE_NAMESPACE_PUSH("GDPerformanceView")
@class UILabel;

SWIFT_CLASS("_TtC17GDPerformanceView20GDPerformanceMonitor")
...
@property (nonatomic) BOOL appVersionHidden;
/// Change it to hide or show device iOS version from monitoring view. Default is false.
@property (nonatomic) BOOL deviceVersionHidden;
/// Instance of GDPerformanceMonitor as singleton.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) GDPerformanceMonitor * _Nonnull sharedInstance;)
+ (GDPerformanceMonitor * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
...
- (void)startMonitoringWithConfiguration:(SWIFT_NOESCAPE void (^ _Nonnull)(UILabel * _Nullable))configuration;
...
- (void)configureWithConfiguration:(SWIFT_NOESCAPE void (^ _Nonnull)(UILabel * _Nullable))configuration;
@end
